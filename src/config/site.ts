...
export const siteConfig = {
  ...
  description:
    "Condominio privado de 426 hectáreas sobre el Río Paraná. Golf profesional, náutica, aeropuerto ejecutivo y lotes desde 1.000 m² con financiación a 84 cuotas.",
