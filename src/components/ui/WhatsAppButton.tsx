    ...
    <AnimatePresence>
      {visible && (
        <motion.a
          ...
          // le dice además adónde lleva el botón.
        ...
        >
          ...
          <svg
            ...
            fill="currentColor"
            aria-hidden="true"
            className="relative z-10 size-6 shrink-0 text-white transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:rotate-[8deg]"
          >
          ...
          <span className="relative z-10 font-sans text-[10px] font-semibold uppercase tracking-[0.16em] text-white">
            {tNav("cta")}
          </span>
        </motion.a>
      )}
